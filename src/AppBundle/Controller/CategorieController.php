...
class CategorieController extends Controller
{
    ...
    {
        // Récupèrent la liste des cat en DB
        $em = $this->getDoctrine()->getManager();

        $categories = $em->getRepository('AppBundle:Categorie')->findAll();

        // Renvoie vers la vue en passant la var 'categories'
        return $this->render('categorie/index.html.twig', array('categories'=>$categories, 'titre'=>'BLABLA'));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {// Exécuté si ajout cliqué
            $em = $this->getDoctrine()->getManager();
